        ...
        if self.mode=='test':
            ...
            if self.mode == 'all':
                ...
                if self.mode == "labeled":
                    ...
                    clean_number_2 = 0
                    for kj in range(len(noise_label)):
                        if noise_label[kj] == train_label[kj]:
                            clean_number_2 += 1


                    label_precision = clean_number / len(pred_idx)
                    label_recall = clean_number / clean_number_2  # 39990 for a40 cifar10
                    ...
                    self.label_recall = label_recall
    ...
    def run(self,mode,pred=[],prob=[]):
        if mode=='warmup':
            ...
            unlabeled_trainloader = DataLoader(
                ...
                shuffle=True,
                num_workers=self.num_workers)     
            return labeled_trainloader, unlabeled_trainloader, labeled_dataset.auc, labeled_dataset.label_precision, labeled_dataset.label_recall
            ...
            eval_loader = DataLoader(
                ...
                shuffle=False,
                num_workers=self.num_workers)          
            return eval_loader, eval_dataset.noise_label